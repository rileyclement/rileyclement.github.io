...
jQuery(document).ready(function () {
	...
	tokyo_tm_modalbox_about_experience();
	tokyo_tm_modalbox_about_education();
...
function tokyo_tm_modalbox_about_experience() {

	"use strict";

	var modalBox = jQuery('#modalbox_experience');
	var opener = jQuery('.tokyo_tm_about .tokyo_tm_button a[box|="experience"]');
...
function tokyo_tm_modalbox_about_education() {

	"use strict";

	var modalBox = jQuery('#modalbox_education');
	var opener = jQuery('.tokyo_tm_about .tokyo_tm_button a[box|="education"]');
	var closer = modalBox.find('.close');
...
function tokyo_tm_contact_form() {
	...
	jQuery(".contact_form #send_message").on('click', function () {
		...
		if (name === '' || email === '' || message === '') {
			...
			fetch("https://formspree.io/f/mayvdzzl", {
				method: "POST",
				body: formData,
				headers: {
				...
				if (response.ok) {
					...
					jQuery(".contact_form .returnmessage").append("<span class='contact_error'>Failed to send message</span>");
					jQuery(".contact_form .returnmessage").slideDown(500).delay(4000).slideUp(500);
				}
			}).catch(error => {
				jQuery(".contact_form .returnmessage").append("<span class='contact_error'>" + error.message + "</span>");
				jQuery(".contact_form .returnmessage").slideDown(500).delay(4000).slideUp(500);
			});
		}
	});
